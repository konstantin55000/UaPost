...
//     country == (currCountry.name).toLowerCase()
    //get value
    for (let currCountry of countryList) { 
        console.log(country, ' == ', (currCountry.name).toLowerCase() );
