...
function loadHandler(event) {
    ...
    //recParseAddress(j, arrayAddr.length);
     chrome.storage.sync.set({'arrAddr': arrayAddr}, function() {
            chrome.storage.sync.set({'j': 0}, function() {
            //
            });
     });
...
function goShipmentPage(){  
            chrome.tabs.executeScript(null, {file: 'addShipment.js'}, function(results){
...
function getCurrentUrl(){
    ...
    chrome.tabs.getSelected(null,function(tab) {
        var tablink = tab.url; console.log(tablink); return tablink;
    });
    return '';
}
    ...
    function processNextAddress(){   
          ...
          chrome.storage.sync.get("j", function (holder) {
            ...
            function() {
             ...
             chrome.storage.sync.set({'j': j}, function(holder2) {
...
//        console.log('got action browse and Upload');
//        fileChooser.click();
//    }
//});
